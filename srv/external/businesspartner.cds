/* checksum : 06a70860e76f63595358d3ccb6455500 */
@cds.external : true
...
entity businesspartner.A_AddressEmailAddress {
...
entity businesspartner.A_AddressFaxNumber {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Address Number'
  key AddressID : String(10) not null;
  @sap.display.format : 'UpperCase'
...
entity businesspartner.A_AddressHomePageURL {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Address Number'
  key AddressID : String(10) not null;
  @sap.display.format : 'UpperCase'
...
entity businesspartner.A_AddressPhoneNumber {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Address Number'
  key AddressID : String(10) not null;
  @sap.display.format : 'UpperCase'
...
entity businesspartner.A_BPAddrDepdntIntlLocNumber {
  @sap.display.format : 'UpperCase'
...
entity businesspartner.A_BPContactToAddress {
  @sap.display.format : 'UpperCase'
  ...
  to_EmailAddress : Association to many businesspartner.A_AddressEmailAddress {  };
  @cds.ambiguous : 'missing on condition?'
  to_FaxNumber : Association to many businesspartner.A_AddressFaxNumber {  };
  @cds.ambiguous : 'missing on condition?'
  to_MobilePhoneNumber : Association to many businesspartner.A_AddressPhoneNumber {  };
  @cds.ambiguous : 'missing on condition?'
  to_PhoneNumber : Association to many businesspartner.A_AddressPhoneNumber {  };
  @cds.ambiguous : 'missing on condition?'
  to_URLAddress : Association to many businesspartner.A_AddressHomePageURL {  };
};
...
entity businesspartner.A_BPContactToFuncAndDept {
  @sap.display.format : 'UpperCase'
  @sap.label : 'BP Relationship No.'
  @sap.quickinfo : 'BP Relationship Number'
  key RelationshipNumber : String(12) not null;
...
entity businesspartner.A_BuPaAddressUsage {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity businesspartner.A_BuPaIdentification {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
@sap.content.version : '1'
@sap.label : 'Industry'
entity businesspartner.A_BuPaIndustry {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Industry'
...
@sap.content.version : '1'
@sap.label : 'Business Partner'
entity businesspartner.A_BusinessPartner {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
  ...
  @cds.ambiguous : 'missing on condition?'
  to_BuPaIdentification : Association to many businesspartner.A_BuPaIdentification {  };
  @cds.ambiguous : 'missing on condition?'
  to_BuPaIndustry : Association to many businesspartner.A_BuPaIndustry {  };
  @cds.ambiguous : 'missing on condition?'
  to_BusinessPartnerAddress : Composition of many businesspartner.A_BusinessPartnerAddress
      on to_BusinessPartnerAddress.BusinessPartner = BusinessPartner;
  @cds.ambiguous : 'missing on condition?'
  to_BusinessPartnerBank : Association to many businesspartner.A_BusinessPartnerBank {  };
  @cds.ambiguous : 'missing on condition?'
  to_BusinessPartnerContact : Association to many businesspartner.A_BusinessPartnerContact {  };
  @cds.ambiguous : 'missing on condition?'
  to_BusinessPartnerRole : Association to many businesspartner.A_BusinessPartnerRole {  };
  @cds.ambiguous : 'missing on condition?'
  to_BusinessPartnerTax : Association to many businesspartner.A_BusinessPartnerTaxNumber {  };
  @cds.ambiguous : 'missing on condition?'
  to_BusPartAddrDepdntTaxNmbr : Association to many businesspartner.A_BusPartAddrDepdntTaxNmbr {  };
  @cds.ambiguous : 'missing on condition?'
  to_Customer : Association to businesspartner.A_Customer {  };
  @cds.ambiguous : 'missing on condition?'
  to_Supplier : Association to businesspartner.A_Supplier {  };
};
...
@sap.content.version : '1'
@sap.label : 'Address'
entity businesspartner.A_BusinessPartnerAddress {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
  ...
  @cds.ambiguous : 'missing on condition?'
  to_AddressUsage : Association to many businesspartner.A_BuPaAddressUsage {  };
  @cds.ambiguous : 'missing on condition?'
  to_BPAddrDepdntIntlLocNumber : Association to businesspartner.A_BPAddrDepdntIntlLocNumber {  };
  @cds.ambiguous : 'missing on condition?'
  to_EmailAddress : Association to many businesspartner.A_AddressEmailAddress {  };
  @cds.ambiguous : 'missing on condition?'
  to_FaxNumber : Association to many businesspartner.A_AddressFaxNumber {  };
...
@sap.content.version : '1'
@sap.label : 'Bank'
entity businesspartner.A_BusinessPartnerBank {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
@sap.content.version : '1'
@sap.label : 'Contact'
entity businesspartner.A_BusinessPartnerContact {
  @sap.display.format : 'UpperCase'
  @sap.label : 'BP Relationship No.'
  @sap.quickinfo : 'BP Relationship Number'
  key RelationshipNumber : String(12) not null;
  ...
  RelationshipCategory : String(6);
  @cds.ambiguous : 'missing on condition?'
  to_ContactAddress : Association to many businesspartner.A_BPContactToAddress {  };
  @cds.ambiguous : 'missing on condition?'
  to_ContactRelationship : Association to businesspartner.A_BPContactToFuncAndDept {  };
};
...
@sap.content.version : '1'
@sap.label : 'Role'
entity businesspartner.A_BusinessPartnerRole {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity businesspartner.A_BusinessPartnerTaxNumber {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity businesspartner.A_BusPartAddrDepdntTaxNmbr {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity businesspartner.A_CustAddrDepdntExtIdentifier {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
...
entity businesspartner.A_CustAddrDepdntInformation {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
...
@sap.content.version : '1'
@sap.label : 'Customer'
entity businesspartner.A_Customer {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
  ...
  County : String(3);
  @cds.ambiguous : 'missing on condition?'
  to_CustAddrDepdntExtIdentifier : Association to many businesspartner.A_CustAddrDepdntExtIdentifier {  };
  @cds.ambiguous : 'missing on condition?'
  to_CustAddrDepdntInformation : Association to many businesspartner.A_CustAddrDepdntInformation {  };
  @cds.ambiguous : 'missing on condition?'
  to_CustomerCompany : Association to many businesspartner.A_CustomerCompany {  };
  @cds.ambiguous : 'missing on condition?'
  to_CustomerSalesArea : Association to many businesspartner.A_CustomerSalesArea {  };
  @cds.ambiguous : 'missing on condition?'
  to_CustomerTaxGrouping : Association to many businesspartner.A_CustomerTaxGrouping {  };
  @cds.ambiguous : 'missing on condition?'
  to_CustomerText : Association to many businesspartner.A_CustomerText {  };
  @cds.ambiguous : 'missing on condition?'
  to_CustomerUnloadingPoint : Association to many businesspartner.A_CustomerUnloadingPoint {  };
  @cds.ambiguous : 'missing on condition?'
  to_CustUnldgPtAddrDepdntInfo : Association to many businesspartner.A_CustUnldgPtAddrDepdntInfo {  };
};
...
entity businesspartner.A_CustomerCompany {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
  ...
  CustomerAccountGroup : String(4);
  @cds.ambiguous : 'missing on condition?'
  to_CompanyText : Association to many businesspartner.A_CustomerCompanyText {  };
  @cds.ambiguous : 'missing on condition?'
  to_CustomerDunning : Association to many businesspartner.A_CustomerDunning {  };
  @cds.ambiguous : 'missing on condition?'
  to_WithHoldingTax : Association to many businesspartner.A_CustomerWithHoldingTax {  };
};
...
entity businesspartner.A_CustomerCompanyText {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  @sap.creatable : 'false'
...
entity businesspartner.A_CustomerDunning {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
...
entity businesspartner.A_CustomerSalesArea {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
  ...
  CustomerAccountGroup : String(4);
  @cds.ambiguous : 'missing on condition?'
  to_PartnerFunction : Association to many businesspartner.A_CustSalesPartnerFunc {  };
  @cds.ambiguous : 'missing on condition?'
  to_SalesAreaTax : Association to many businesspartner.A_CustomerSalesAreaTax {  };
  @cds.ambiguous : 'missing on condition?'
  to_SalesAreaText : Association to many businesspartner.A_CustomerSalesAreaText {  };
  @cds.ambiguous : 'missing on condition?'
  to_SlsAreaAddrDepdntInfo : Association to many businesspartner.A_CustSlsAreaAddrDepdntInfo {  };
};
...
entity businesspartner.A_CustomerSalesAreaTax {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
  ...
  @cds.ambiguous : 'missing on condition?'
  to_SlsAreaAddrDepdntTax : Association to many businesspartner.A_CustSlsAreaAddrDepdntTaxInfo {  };
};
...
entity businesspartner.A_CustomerSalesAreaText {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  @sap.creatable : 'false'
...
entity businesspartner.A_CustomerTaxGrouping {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  @sap.creatable : 'false'
...
entity businesspartner.A_CustomerText {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  @sap.creatable : 'false'
...
entity businesspartner.A_CustomerUnloadingPoint {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
...
entity businesspartner.A_CustomerWithHoldingTax {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
...
entity businesspartner.A_CustSalesPartnerFunc {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
...
entity businesspartner.A_CustSlsAreaAddrDepdntInfo {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
...
entity businesspartner.A_CustSlsAreaAddrDepdntTaxInfo {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
...
entity businesspartner.A_CustUnldgPtAddrDepdntInfo {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
...
@sap.content.version : '1'
@sap.label : 'Supplier'
entity businesspartner.A_Supplier {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Supplier'
  @sap.quickinfo : 'Account Number of Supplier'
  ...
  @cds.ambiguous : 'missing on condition?'
  to_SupplierCompany : Association to many businesspartner.A_SupplierCompany {  };
  @cds.ambiguous : 'missing on condition?'
  to_SupplierPurchasingOrg : Association to many businesspartner.A_SupplierPurchasingOrg {  };
  @cds.ambiguous : 'missing on condition?'
  to_SupplierText : Association to many businesspartner.A_SupplierText {  };
};
...
entity businesspartner.A_SupplierCompany {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Supplier'
  @sap.quickinfo : 'Account Number of Supplier'
  key Supplier : String(10) not null;
  ...
  SupplierAccountGroup : String(4);
  @cds.ambiguous : 'missing on condition?'
  to_CompanyText : Association to many businesspartner.A_SupplierCompanyText {  };
  @cds.ambiguous : 'missing on condition?'
  to_Supplier : Association to businesspartner.A_Supplier {  };
  @cds.ambiguous : 'missing on condition?'
  to_SupplierDunning : Association to many businesspartner.A_SupplierDunning {  };
  @cds.ambiguous : 'missing on condition?'
  to_SupplierWithHoldingTax : Association to many businesspartner.A_SupplierWithHoldingTax {  };
};
...
entity businesspartner.A_SupplierCompanyText {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Supplier'
  @sap.quickinfo : 'Account Number of Supplier'
  @sap.creatable : 'false'
...
entity businesspartner.A_SupplierDunning {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Supplier'
  @sap.quickinfo : 'Account Number of Supplier'
  key Supplier : String(10) not null;
...
entity businesspartner.A_SupplierPartnerFunc {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Supplier'
  @sap.quickinfo : 'Account Number of Supplier'
  key Supplier : String(10) not null;
...
entity businesspartner.A_SupplierPurchasingOrg {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Supplier'
  ...
  SupplierAccountGroup : String(4);
  @cds.ambiguous : 'missing on condition?'
  to_PartnerFunction : Association to many businesspartner.A_SupplierPartnerFunc {  };
  @cds.ambiguous : 'missing on condition?'
  to_PurchasingOrgText : Association to many businesspartner.A_SupplierPurchasingOrgText {  };
};
...
entity businesspartner.A_SupplierPurchasingOrgText {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Supplier'
  @sap.quickinfo : 'Account Number of Supplier'
  @sap.creatable : 'false'
...
entity businesspartner.A_SupplierText {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Supplier'
  @sap.quickinfo : 'Account Number of Supplier'
  @sap.creatable : 'false'
...
entity businesspartner.A_SupplierWithHoldingTax {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Supplier'
  @sap.quickinfo : 'Account Number of Supplier'
  key Supplier : String(10) not null;
