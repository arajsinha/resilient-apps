...
export class Verification extends _._managedAspect(_._cuidAspect(_VerificationAspect(__.Entity))) {}
export class Verifications extends Array<Verification> {}
...
export class Address extends _._cuidAspect(_AddressAspect(__.Entity)) {}
